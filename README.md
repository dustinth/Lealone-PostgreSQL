...
代码导入 IDE 后，直接运行 [PgServerStart](https://github.com/lealone/Lealone-PostgreSQL/blob/main/src/test/java/org/lealone/plugins/postgresql/test/PgServerStart.java) 
